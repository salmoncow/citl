...
### FU-01 · L · Unify the standings derivations in `src/services/standings.ts`; decide whether publish rewrites week docs — **DONE ([PR #224](https://github.com/salmoncow/citl/pull/224), 2026-07-13) via [`features/archive/005-standings-unification/`](../../features/archive/005-standings-unification/spec.md)**
