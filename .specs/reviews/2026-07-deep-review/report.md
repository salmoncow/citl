...
**Still open** (tracked in [backlog.md](backlog.md)): only the two post-WS-4 follow-ups appended 2026-07-12 — FU-01 (standings-derivation unification per spec 003 DD-4) and FU-02 (optional score-service API split per spec 003 Open Question 1). Both are spec-gated design items, not defects. Every numbered finding F-01–F-63 is now resolved or intentionally dispositioned.
