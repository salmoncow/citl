...
export function aboutView(): string {
  return `
    <section class="page-hero bleed on-dark" aria-labelledby="about-title">
      <div class="page-hero__inner">
        <span class="eyebrow eyebrow--on-dark">About the league</span>
        <h1 id="about-title">Trap on Tuesdays</h1>
        <p class="page-hero__lede">How the league works, what it costs, and where we shoot.</p>
      </div>
    </section>
